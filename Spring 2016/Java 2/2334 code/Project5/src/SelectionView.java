...
/**
 * This class fulfills the role of the main view in the MVC format
 */
...
public class SelectionView extends JFrame implements ActionListener{
	...
	public SelectionView() {
		...
		jmiSave.setToolTipText("No information available");
		jmiExport.setToolTipText("No information available");
		
		//add tooltips for Edit menu items
		jmiAdd.setToolTipText("Add object of corresponding button to list");
		jmiEdit.setToolTipText("No information available");
		jmiDelete.setToolTipText("No information available");
		jmiClear.setToolTipText("No information available");
		jmiClearAll.setToolTipText("No information available");
		
		displayMenu.setToolTipText("No information available");
...
//			refireSelectedButton();
			...
			jmiSave.setToolTipText("Save to a .txt file");
			jmiExport.setEnabled(true);
			jmiExport.setToolTipText("Export information to a binary .txt file");
...
//			refireSelectedButton();
			...
			jmiPieChart.setToolTipText("Generate PieChart of selected MediaMaker's info");
			jmiHistogram.setToolTipText("Generate Histogram of selected MediaMaker's info");
	...
	public void addDoSButtonListener(ActionListener addDoSListener) {
		jmiDoS.addActionListener(addDoSListener);
	}
