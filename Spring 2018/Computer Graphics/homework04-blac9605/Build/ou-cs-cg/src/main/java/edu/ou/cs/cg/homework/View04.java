...
/**
 * The <CODE>View04</CODE> class.<P>
 *
 * @author  Chris Weaver
 * @version %I%, %G%
 */
public final class View04 implements GLEventListener
{
	//**********************************************************************
	...
	private final KeyHandler04		keyHandler;
	private final MouseHandler04		mouseHandler;
	...
	public View04(GLJPanel canvas)
	{
		...
		keyHandler = new KeyHandler04(this);
		mouseHandler = new MouseHandler04(this);
	}
